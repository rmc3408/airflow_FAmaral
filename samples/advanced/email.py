...
dag =  DAG('email_test', description="Email",
        ...
        catchup=False, default_view='graph', tags=['email'])
...
task6 = BashOperator(task_id="tsk6",bash_command="sleep 1",dag=dag, trigger_rule='all_failed' )

send_email = EmailOperator(task_id="send_email",
                to="molinaro.raphael@gmail.com",
